...
public class Terrain implements KeyListener{
	public static Dimension mySize;
    ...
    public void draw(GL2 gl) {   
        ...
        float[] sunPos = {(float) (timeP*mySize.getWidth())*5,timeC*5 * 5,(float)(mySize.getHeight()/2 * 5),0};
        if(timeC < 0.5){
        	sunColor[2] = 0.0f;
        }
        ...
        if(!sun){
            ...
            gl.glBindTexture(GL.GL_TEXTURE_2D, Game.sunTexture.getTextureID());//sun
...
//    	gl.glBindTexture(GL2.GL_TEXTURE_2D, Game.skyTexture.getTextureID());        
//      gl.glBegin(GL2.GL_POLYGON);
//         gl.glTexCoord2d(0.0, 0.0); gl.glVertex3d(-10.0, 0.0, -7.0);
//         gl.glTexCoord2d(1, 0.0); gl.glVertex3d(10.0, 0.0, -7.0);
//         gl.glTexCoord2d(1, 1); gl.glVertex3d(10.0, 12.0, -7.0);
//         gl.glTexCoord2d(0.0, 1); gl.glVertex3d(-10.0, 12.0, -7.0);
//      gl.glEnd();
        
        
        
        
        gl.glBindTexture(GL.GL_TEXTURE_2D, Game.grassTexture.getTextureID());/////3
